...
class ENGINE_API URendererSettings : public UDeveloperSettings
{
	...
	*/
	...
	UPROPERTY(config, EditAnywhere, Category = MobileShaderPermutationReduction, meta = (
		ConsoleVariable = "r.Mobile.EnableClusterLighting",
		DisplayName = "Support Cluster Lighting",
		ToolTip = "Generate shaders to support mobile cluster lighting.",
		ConfigRestartRequired = true))
		uint32 bMobilenableClusterLighting : 1;
	// end
