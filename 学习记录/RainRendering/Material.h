...
public:
	...
	UPROPERTY(EditAnywhere, Category = Translucency, meta = (DisplayName = "Mobile DownSample Separate Translucency"), AdvancedDisplay)
	uint8 bEnableMobileDownsampleSeparateTranslucency : 1;
	//End
