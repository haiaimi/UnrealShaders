...
//YJH Created By 2020-7-18
static TAutoConsoleVariable<int32> CVarMobileSeparateTranslucency(
	TEXT("r.Mobile.SeparateTranslucency"),
	1,
...
void FMobileSceneRenderer::Render(FRHICommandListImmediate& RHICmdList)
{
	...
	if (ViewFamily.EngineShowFlags.Translucency)
	{
		...
		RenderTranslucency(RHICmdList, ViewList, !bGammaSpace || bRenderToSceneColor, bShouldRenderDownSampleTranslucency);
		FRHICommandListExecutor::GetImmediateCommandList().PollOcclusionQueries();
		RHICmdList.ImmediateFlush(EImmediateFlushType::DispatchToRHIThread);
	}
