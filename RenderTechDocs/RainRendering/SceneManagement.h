...
public:
	...
	class USkyAtmosphereComponent* TempComponent;
#endif 
...
protected:
	...
	friend class FRainDepthProjectedInfo;
...
float ENGINE_API ComputeBoundsScreenSquared(const FBoxSphereBounds& Bounds, const FVector4& ViewOrigin, const FSceneView& View);

float ENGINE_API ComputeBoundsScreenSquared(const FBoxSphereBounds& Bounds, const FVector4& ViewOrigin, const FMatrix& ProjMatrix, const FMatrix& ViewProjMatrix);
