...
namespace FluidSimulation3D
{
	...
	IMPLEMENT_SHADER_TYPE(, FAdvectVelocityCS, TEXT("/SLShaders/Fluid3D.usf"), TEXT("AdvectVelocity"), SF_Compute)
	...
	IMPLEMENT_SHADER_TYPE(, FVorticityCS, TEXT("/SLShaders/Fluid3D.usf"), TEXT("ComputeVorticity"), SF_Compute)
	...
	IMPLEMENT_SHADER_TYPE(, FVorticityForceCS, TEXT("/SLShaders/Fluid3D.usf"), TEXT("VorticityForce"), SF_Compute)
	...
	IMPLEMENT_SHADER_TYPE(, FDivergenceCS, TEXT("/SLShaders/Fluid3D.usf"), TEXT("DivergenceCS"), SF_Compute)
	...
	IMPLEMENT_SHADER_TYPE(, FAddImpluseCS, TEXT("/SLShaders/Fluid3D.usf"), TEXT("AddImpluse"), SF_Compute)
	...
	IMPLEMENT_SHADER_TYPE(, FJacobiSolverCS, TEXT("/SLShaders/Fluid3D.usf"), TEXT("Jacobi"), SF_Compute)
	...
	IMPLEMENT_SHADER_TYPE(, FSubstractGradientCS, TEXT("/SLShaders/Fluid3D.usf"), TEXT("SubstractGradient"), SF_Compute)
