...
IMPLEMENT_SHADER_TYPE(template<>, FFluidVolumeVS<BackwardVolume>, TEXT("/SLShaders/RenderFluidVolume.usf"), TEXT("VolumeBackVS"), SF_Vertex);
IMPLEMENT_SHADER_TYPE(template<>, FFluidVolumeVS<FrontVolume>, TEXT("/SLShaders/RenderFluidVolume.usf"), TEXT("VolumeFrontVS"), SF_Vertex);
...
IMPLEMENT_SHADER_TYPE(template<>, FFluidVolumePS<BackwardVolume>, TEXT("/SLShaders/RenderFluidVolume.usf"), TEXT("VolumeBackPS"), SF_Pixel);
IMPLEMENT_SHADER_TYPE(template<>, FFluidVolumePS<FrontVolume>, TEXT("/SLShaders/RenderFluidVolume.usf"), TEXT("VolumeFrontPS"), SF_Pixel);
...
IMPLEMENT_SHADER_TYPE(, FFluidVolumeQuadVS, TEXT("/SLShaders/RenderFluidVolume.usf"), TEXT("VolumeRayMarchVS"), SF_Vertex);
...
IMPLEMENT_SHADER_TYPE(, FFluidVolumeRayMarchPS, TEXT("/SLShaders/RenderFluidVolume.usf"), TEXT("VolumeRayMarchPS"), SF_Pixel);
