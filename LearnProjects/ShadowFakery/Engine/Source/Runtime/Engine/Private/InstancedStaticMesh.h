...
private:
	...
	class FInstanceShadowFakeryBuffer : public FVertexBuffer
	{
		virtual FString GetFriendlyName() const override { return TEXT("FInstanceShadowFakeryBuffer"); }
	} InstanceShadowFakeryBuffer;
	FShaderResourceViewRHIRef InstanceShadowFakerySRV;
	//end
...
struct FInstancedStaticMeshDataType
{
	...
	//#Change by wh, 2019/6/10 
	FVertexStreamComponent InstanceShadowFakeryComponent;
	//end
	...
	//#Change by wh, 2019/6/10 
	FRHIShaderResourceView* InstanceShadowFakerySRV = nullptr;
	//end
...
public:
	...
	*/
	...
	inline FRHIShaderResourceView* GetInstanceShadowFakerySRV() const
	{
		return Data.InstanceShadowFakerySRV;
	}
